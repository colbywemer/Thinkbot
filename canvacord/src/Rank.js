...
class Rank {
    ...
    */
     ...
     * @returns {Rank}
     */
    setRank(data, color, text = "RANK", display = true) {
        ...
        this.data.rank.color = color && typeof color === "string" ? color : "#FFFFFF";
        this.data.rank.textColor = color && typeof color === "string" ? color : "#FFFFFF";
     ...
     * @returns {Rank}
     */
    setLevel(data, color, text = "LEVEL", display = true) {
        if (typeof data !== "number") throw new Error(`Level data must be a number, received ${typeof data}!`);
        ...
        this.data.level.textColor = color && typeof color === "string" ? color : "#FFFFFF";
        this.data.level.color = color && typeof color === "string" ? color : "#FFFFFF";
    ...
    async build(ops = { fontX: "MANROPE_BOLD,NOTO_COLOR_EMOJI", fontY: "MANROPE_BOLD,NOTO_COLOR_EMOJI" }) {
        ...
        // apply username
        !this.data.renderEmojis ? ctx.fillText(`${name}`, 257 + 15, yCoord) : await Util.renderEmoji(ctx, name, 257 + 18.5, yCoord);
